        ...
        child: Card(
          ...
          child: Container(
            ...
            child: Row(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(namaBulan,style: TextStyle(fontSize: 26),),
                Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(checkupDua,style: TextStyle(color: Colors.white),),
                      ),
                    ),
                    Container(
                      width: 80,
                      ...
                      child: Center(
                        child: Text(checkupSatu,style: TextStyle(color: Colors.white),),
                      ),
                    )
                  ],
                )
